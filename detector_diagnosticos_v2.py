"""
detector_diagnosticos_v2.py — Detector inteligente de diagnósticos.

NOVIDADES em relação ao v1:
  • Remove prefixos como "Sugestivo de", "Compatível com" para agrupar
    (assim "Sugestivo de rânula" e "Rânula" caem no mesmo grupo).
  • Já junta erros de digitação automaticamente (sugere a forma mais usada).
  • Mostra quais prefixos foram encontrados, para você conferir.

⚠️ NÃO altera o banco. Só gera revisar_diagnosticos_v2.xlsx para revisão.

Rode na sua máquina:  python detector_diagnosticos_v2.py
"""
...
SAIDA = Path(__file__).parent / "revisar_diagnosticos_v2.xlsx"
