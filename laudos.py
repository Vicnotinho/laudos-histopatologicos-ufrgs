...
PASTA_IMAGENS = Path(__file__).parent / "dados" / "imagens"
PASTA_IMAGENS.mkdir(parents=True, exist_ok=True)

# localiza o logo (procura na pasta do programa)
def _caminho_logo():
    for nome in ("Logo-Odonto-UFRGS.png", "logo-odonto-ufrgs.png", "logo.png"):
